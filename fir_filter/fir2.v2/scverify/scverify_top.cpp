...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , fir2_INST("rtl", TO_QUOTED_STRING(TOP_HDL_ENTITY))
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    fir2_INST.clk(clk);
    fir2_INST.rst(TLS_rst);
    fir2_INST.x_rsc_dat(TLS_x_rsc_dat);
    fir2_INST.x_rsc_triosy_lz(TLS_x_rsc_triosy_lz);
    fir2_INST.shift_reg_rsc_zout(TLS_shift_reg_rsc_zout);
    fir2_INST.shift_reg_rsc_lzout(TLS_shift_reg_rsc_lzout);
    fir2_INST.shift_reg_rsc_zin(TLS_shift_reg_rsc_zin);
    fir2_INST.shift_reg_rsc_triosy_lz(TLS_shift_reg_rsc_triosy_lz);
    fir2_INST.return_rsc_dat(TLS_return_rsc_dat);
    fir2_INST.return_rsc_triosy_lz(TLS_return_rsc_triosy_lz);
