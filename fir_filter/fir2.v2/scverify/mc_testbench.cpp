...
extern "C++" int fir2(int x,  int *shift_reg);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
int testbench::exec_fir2(int x,  int *shift_reg) {
   return mc_testbench::exec_fir2(x, shift_reg);
}
#endif
...
int mc_testbench::exec_fir2(int x,  int *shift_reg)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(x, shift_reg);
   int _TOP__return = fir2(x, shift_reg);
