...
typedef
    ccs_design::HDL::fir1 ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<32> > x_rsc_dat;
  sc_out<sc_logic> x_rsc_triosy_lz;
  sc_out<sc_lv<352> > shift_reg_rsc_zout;
  sc_out<sc_logic> shift_reg_rsc_lzout;
  sc_in<sc_lv<352> > shift_reg_rsc_zin;
  sc_out<sc_logic> shift_reg_rsc_triosy_lz;
  sc_out<sc_lv<32> > return_rsc_dat;
