ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /opt/mentorgraphics/Catapult_10.5c/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /opt/mentorgraphics/modelsim_SE106/modeltech/linux_x86_64
...
QuestaSIM_QUESTA_VISUALIZER                         := can't read "VISUALIZER_HOME": no such variable
...
ifeq "$(NCSim_NC_ROOT)" ""
NCSim_NC_ROOT                                       := can't read "NC_ROOT": no such variable
...
OSCI_SYSTEMC_INCLUDE                                := /opt/mentorgraphics/Catapult_10.5c/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                    := /opt/mentorgraphics/Catapult_10.5c/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(OSCI_LCOVDIR)" ""
OSCI_LCOVDIR                                        := can't read "LCOVDIR": no such variable
export OSCI_LCOVDIR
endif
ifeq "$(Novas_NOVAS_INST_DIR)" ""
Novas_NOVAS_INST_DIR                                := can't read "VERDI_HOME": no such variable
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                        := /opt/synopsys/vcs/O-2018.09-SP2
export VCS_VCS_HOME
endif
...
VCS_VG_GNU_PACKAGE                                  := can't read "VG_GNU_PACKAGE": no such variable
...
DesignAnalyzer_Exe                                  := can't read "CATAPULT_DESIGN_ANALYZER": no such variable
...
ifeq "$(RTLCompiler_SynthesisFlowType)" ""
RTLCompiler_SynthesisFlowType                       := asic
export RTLCompiler_SynthesisFlowType
endif
ifeq "$(RTLCompiler_FlowSuffix)" ""
RTLCompiler_FlowSuffix                              := rc
export RTLCompiler_FlowSuffix
endif
ifeq "$(RTLCompiler_SearchPath)" ""
RTLCompiler_SearchPath                              := 
export RTLCompiler_SearchPath
endif
ifeq "$(RTLCompiler_ShellExe)" ""
RTLCompiler_ShellExe                                := rc
export RTLCompiler_ShellExe
endif
ifeq "$(RTLCompiler_Path)" ""
RTLCompiler_Path                                    := 
export RTLCompiler_Path
endif
ifeq "$(RTLCompiler_Flags)" ""
RTLCompiler_Flags                                   := 
export RTLCompiler_Flags
endif
ifeq "$(RTLCompiler_LicenseServer)" ""
RTLCompiler_LicenseServer                           := 
export RTLCompiler_LicenseServer
endif
ifeq "$(RTLCompiler_FOLDERNAME)" ""
RTLCompiler_FOLDERNAME                              := RTL Compiler
export RTLCompiler_FOLDERNAME
endif
ifeq "$(RTLCompiler_OutNetlistName)" ""
RTLCompiler_OutNetlistName                          := gate.rc
export RTLCompiler_OutNetlistName
endif
ifeq "$(RTLCompiler_OutNetlistFormat)" ""
RTLCompiler_OutNetlistFormat                        := verilog
export RTLCompiler_OutNetlistFormat
endif
ifeq "$(RTLCompiler_TimingReportingMode)" ""
RTLCompiler_TimingReportingMode                     := p2p
export RTLCompiler_TimingReportingMode
endif
ifeq "$(RTLCompiler_GenerateGateSdf)" ""
RTLCompiler_GenerateGateSdf                         := true
export RTLCompiler_GenerateGateSdf
endif
ifeq "$(RTLCompiler_MaxLoopIterations)" ""
RTLCompiler_MaxLoopIterations                       := 1000
export RTLCompiler_MaxLoopIterations
endif
ifeq "$(RTLCompiler_EnableClockGating)" ""
RTLCompiler_EnableClockGating                       := false
export RTLCompiler_EnableClockGating
endif
ifeq "$(RTLCompiler_EnablePowerReporting)" ""
RTLCompiler_EnablePowerReporting                    := false
export RTLCompiler_EnablePowerReporting
endif
ifeq "$(RTLCompiler_CustomScriptDirPath)" ""
RTLCompiler_CustomScriptDirPath                     := 
export RTLCompiler_CustomScriptDirPath
endif
ifeq "$(RTLCompiler_MultiplierArchitecture)" ""
RTLCompiler_MultiplierArchitecture                  := non_booth
export RTLCompiler_MultiplierArchitecture
endif
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /opt/mentorgraphics/modelsim_SE106/modeltech/linux_x86_64
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
