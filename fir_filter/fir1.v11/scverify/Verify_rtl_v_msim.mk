...
# Generated date: Tue Feb 09 17:13:10 EST 2021
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir1.v11
#   WORKING_DIR   /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir1.v11/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./fir_filter/fir1.v11
PROJ2SOLN = ./fir_filter/fir1.v11
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir1.v11/rtl.v
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./fir_filter/fir1.v11/scverify_msim.tcl
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_fir1 -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
