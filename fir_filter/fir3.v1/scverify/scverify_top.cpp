...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , fir3_INST("rtl", TO_QUOTED_STRING(TOP_HDL_ENTITY))
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    fir3_INST.clk(clk);
    fir3_INST.rst(TLS_rst);
    fir3_INST.x_rsc_dat(TLS_x_rsc_dat);
    fir3_INST.x_rsc_triosy_lz(TLS_x_rsc_triosy_lz);
    fir3_INST.return_rsc_dat(TLS_return_rsc_dat);
    fir3_INST.return_rsc_triosy_lz(TLS_return_rsc_triosy_lz);
