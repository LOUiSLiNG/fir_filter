...
public:
  ...
  sc_signal<sc_lv<32> >                                      TLS_x_rsc_dat;
  sc_signal<sc_logic>                                        TLS_x_rsc_triosy_lz;
  sc_signal<sc_lv<352> >                                     TLS_shift_reg_rsc_zout;
  sc_signal<sc_logic>                                        TLS_shift_reg_rsc_lzout;
  sc_signal<sc_lv<352> >                                     TLS_shift_reg_rsc_zin;
  sc_signal<sc_logic>                                        TLS_shift_reg_rsc_triosy_lz;
  sc_signal<sc_lv<32> >                                      TLS_return_rsc_dat;
  sc_signal<sc_logic>                                        TLS_return_rsc_triosy_lz;
  ccs_DUT_wrapper                                            fir1_INST;
  ccs_in_trans_rsc_v1<1,32 >                                 x_rsc_INST;
  mgc_inout_prereg_en_trans_rsc_v1<1,352 >                   shift_reg_rsc_INST;
  ccs_out_trans_rsc_v1<1,32 >                                return_rsc_INST;
  tlm::tlm_fifo<int >                                        TLS_in_fifo_x;
  tlm::tlm_fifo<mc_wait_ctrl>                                TLS_in_wait_ctrl_fifo_x;
  mc_trios_input_monitor                                     trios_monitor_x_rsc_triosy_lz_INST;
  mc_input_transactor<int,32,true>                           transactor_x;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,11> >               TLS_in_fifo_shift_reg;
  tlm::tlm_fifo<mc_wait_ctrl>                                TLS_in_wait_ctrl_fifo_shift_reg;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,11> >               TLS_out_fifo_shift_reg;
  tlm::tlm_fifo<mc_wait_ctrl>                                TLS_out_wait_ctrl_fifo_shift_reg;
  mc_trios_inout_monitor                                     trios_monitor_shift_reg_rsc_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<int,11>,32,true>  transactor_shift_reg;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_rst("TLS_rst")
    , TLS_x_rsc_dat("TLS_x_rsc_dat")
    , TLS_x_rsc_triosy_lz("TLS_x_rsc_triosy_lz")
    , TLS_shift_reg_rsc_zout("TLS_shift_reg_rsc_zout")
    , TLS_shift_reg_rsc_lzout("TLS_shift_reg_rsc_lzout")
    , TLS_shift_reg_rsc_zin("TLS_shift_reg_rsc_zin")
    , TLS_shift_reg_rsc_triosy_lz("TLS_shift_reg_rsc_triosy_lz")
    , TLS_return_rsc_dat("TLS_return_rsc_dat")
    , TLS_return_rsc_triosy_lz("TLS_return_rsc_triosy_lz")
    , fir1_INST("rtl", TO_QUOTED_STRING(TOP_HDL_ENTITY))
    , x_rsc_INST("x_rsc", true)
    , shift_reg_rsc_INST("shift_reg_rsc", true)
    ...
    , TLS_in_fifo_shift_reg("TLS_in_fifo_shift_reg", -1)
    , TLS_in_wait_ctrl_fifo_shift_reg("TLS_in_wait_ctrl_fifo_shift_reg", -1)
    , TLS_out_fifo_shift_reg("TLS_out_fifo_shift_reg", -1)
    , TLS_out_wait_ctrl_fifo_shift_reg("TLS_out_wait_ctrl_fifo_shift_reg", -1)
    , trios_monitor_shift_reg_rsc_triosy_lz_INST("trios_monitor_shift_reg_rsc_triosy_lz_INST")
    , transactor_shift_reg("transactor_shift_reg", 0, 352, 0)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    fir1_INST.clk(clk);
    fir1_INST.rst(TLS_rst);
    fir1_INST.x_rsc_dat(TLS_x_rsc_dat);
    fir1_INST.x_rsc_triosy_lz(TLS_x_rsc_triosy_lz);
    fir1_INST.shift_reg_rsc_zout(TLS_shift_reg_rsc_zout);
    fir1_INST.shift_reg_rsc_lzout(TLS_shift_reg_rsc_lzout);
    fir1_INST.shift_reg_rsc_zin(TLS_shift_reg_rsc_zin);
    fir1_INST.shift_reg_rsc_triosy_lz(TLS_shift_reg_rsc_triosy_lz);
    fir1_INST.return_rsc_dat(TLS_return_rsc_dat);
    fir1_INST.return_rsc_triosy_lz(TLS_return_rsc_triosy_lz);

    x_rsc_INST.dat(TLS_x_rsc_dat);
    x_rsc_INST.clk(clk);
    x_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_1)));

    shift_reg_rsc_INST.zin(TLS_shift_reg_rsc_zin);
    shift_reg_rsc_INST.lzout(TLS_shift_reg_rsc_lzout);
    shift_reg_rsc_INST.zout(TLS_shift_reg_rsc_zout);
    shift_reg_rsc_INST.clk(clk);
    shift_reg_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_2)));
    ...
    transactor_x.register_block(&x_rsc_INST, x_rsc_INST.basename(), TLS_x_rsc_triosy_lz, 0, 0, 1);

    trios_monitor_shift_reg_rsc_triosy_lz_INST.trios(TLS_shift_reg_rsc_triosy_lz);
    trios_monitor_shift_reg_rsc_triosy_lz_INST.register_mon(&catapult_monitor_INST);

    transactor_shift_reg.in_fifo(TLS_in_fifo_shift_reg);
    transactor_shift_reg.in_wait_ctrl_fifo(TLS_in_wait_ctrl_fifo_shift_reg);
    transactor_shift_reg.out_fifo(TLS_out_fifo_shift_reg);
    transactor_shift_reg.out_wait_ctrl_fifo(TLS_out_wait_ctrl_fifo_shift_reg);
    transactor_shift_reg.bind_clk(clk, true, rst);
    transactor_shift_reg.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_shift_reg.register_block(&shift_reg_rsc_INST, shift_reg_rsc_INST.basename(), TLS_shift_reg_rsc_triosy_lz,
        0, 0, 1);
    ...
    testbench_INST.ccs_x(TLS_in_fifo_x);
    testbench_INST.ccs_wait_ctrl_x(TLS_in_wait_ctrl_fifo_x);
    testbench_INST.ccs_shift_reg_IN(TLS_in_fifo_shift_reg);
    testbench_INST.ccs_wait_ctrl_shift_reg_IN(TLS_in_wait_ctrl_fifo_shift_reg);
    testbench_INST.ccs_shift_reg(TLS_out_fifo_shift_reg);
    testbench_INST.ccs_wait_ctrl_shift_reg(TLS_out_wait_ctrl_fifo_shift_reg);
...
void scverify_top::start_of_simulation() {
  ...
  if (SCVerify_AUTOWAIT) {
    ...
    transactor_shift_reg.set_auto_wait_limit(l);
...
void scverify_top::setup_debug() {
  ...
  static int transactor_shift_reg_flags = MC_DEFAULT_TRANSACTOR_LOG;
  ...
  static int transactor_shift_reg_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_return_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
#endif
  static int transactor_x_count = -1;
  static int transactor_shift_reg_count = -1;
  ...
  if (debug_cmds.is_open()) {
    ...
    debug("transactor_shift_reg",transactor_shift_reg_flags,transactor_shift_reg_count);
...
void scverify_top::debug(const char* varname, int flags, int count) {
  ...
  if (strcmp(varname,"transactor_shift_reg") == 0)
    xlator_p = &transactor_shift_reg;
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    if (toggle_hw_reset) {
      ...
      transactor_shift_reg.reset_streams();
