...
public:
  ...
  sc_signal<sc_lv<4096> >                                      TLS_input_rsc_dat;
  sc_signal<sc_logic>                                          TLS_input_rsc_triosy_lz;
  sc_signal<sc_lv<4096> >                                      TLS_output_rsc_dat;
  sc_signal<sc_logic>                                          TLS_output_rsc_triosy_lz;
  ccs_DUT_wrapper                                              fir_INST;
  ccs_in_trans_rsc_v1<1,4096 >                                 input_rsc_INST;
  ccs_out_trans_rsc_v1<1,4096 >                                output_rsc_INST;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,128> >                TLS_in_fifo_input;
  tlm::tlm_fifo<mc_wait_ctrl>                                  TLS_in_wait_ctrl_fifo_input;
  mc_trios_input_monitor                                       trios_monitor_input_rsc_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<int,128>,32,true>   transactor_input;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,128> >                TLS_out_fifo_output;
  tlm::tlm_fifo<mc_wait_ctrl>                                  TLS_out_wait_ctrl_fifo_output;
  mc_trios_output_monitor                                      trios_monitor_output_rsc_triosy_lz_INST;
  mc_output_transactor<mgc_sysc_ver_array1D<int,128>,32,true>  transactor_output;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , transactor_input("transactor_input", 0, 4096, 0)
    ...
    , transactor_output("transactor_output", 0, 4096, 0)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 386, 386, 0)
    , catapult_monitor_INST("Monitor", clk, true, 386LL, 386LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    fir_INST.input_rsc_triosy_lz(TLS_input_rsc_triosy_lz);
    fir_INST.output_rsc_dat(TLS_output_rsc_dat);
    fir_INST.output_rsc_triosy_lz(TLS_output_rsc_triosy_lz);
