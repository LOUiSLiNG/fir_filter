...
# Generated date: Wed Feb 03 19:34:34 EST 2021
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir.v1
#   WORKING_DIR   /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./fir_filter/fir.v1
PROJ2SOLN = ./fir_filter/fir.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/dss545/small_projects/fir_filter/fir_filter/fir_filter/fir.v1/concat_sim_rtl.v
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./fir_filter/fir.v1/scverify_msim.tcl
...
CXX_SRC  = ../../fir_filter.c/fir_filter.c.cxxts ../../fir_filter_tb.c/fir_filter_tb.c.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts
...
$(TARGET)/fir_filter.c.cxxts: ../../fir_filter.c
$(TARGET)/fir_filter_tb.c.cxxts: ../../fir_filter_tb.c
...
$(TARGET)/fir_filter_tb.c.cxxts: CXX_OPTS=
$(TARGET)/scverify_top.cpp.cxxts: CXX_OPTS=
$(TARGET)/mc_testbench.cpp.cxxts: CXX_OPTS=$(F_WRAP_OPT)
$(TARGET)/fir_filter.c.cxxts: CXX_OPTS=
# 
# Specify dependencies
$(TARGET)/fir_filter.c.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
$(TARGET)/fir_filter_tb.c.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
