...
# Generated date: Tue Feb 09 23:00:58 EST 2021
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/dss545/small_projects/fir_filter/fir_filter/auto_fir_filter3/fir3.v1
#   WORKING_DIR   /home/dss545/small_projects/fir_filter/fir_filter/auto_fir_filter3/fir3.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./auto_fir_filter3/fir3.v1
PROJ2SOLN = ./auto_fir_filter3/fir3.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/dss545/small_projects/fir_filter/fir_filter/auto_fir_filter3/fir3.v1/rtl.v
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./auto_fir_filter3/fir3.v1/scverify_msim.tcl
...
CXXFLAGS += -DCATAPULT -DDECRYPTION -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_fir3 -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
