...
solution file add ./fir_filter/fir_filter.c -type C++
solution file add ./fir_filter/fir_filter_tb.c -type C++ -exclude true
solution file add ./fir_filter/fir_filter.h -type C++
